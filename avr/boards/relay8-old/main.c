...
struct proto_widget widgets[] = {
	PROTO_WIDGET_RELAY(0,50),
	PROTO_WIDGET_RELAY(1,50),
	PROTO_WIDGET_RELAY(2,50),
	PROTO_WIDGET_RELAY(3,50),
	PROTO_WIDGET_RELAY(4,50),
	PROTO_WIDGET_RELAY(5,50),
	PROTO_WIDGET_RELAY(6,50),
	PROTO_WIDGET_RELAY(7,50),
};
